...
const fetchComments = () => {
  ...
  arrayOfPosts.map((post, index) => {
    ...
    li.appendChild(text)
    allPosts.append(li)
    h3.innerText = "Display Comments"
  })
}


// Your job now is to follow the functions above and use them as templates to build the functionality to the buttons in the index.html file already have laid out in it. This way you can learn how to build fetch requests and work with other APIs and become a real developer!!